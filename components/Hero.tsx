    ...
    <section className="hero" id="hero">
      ...
      <div className="container hero-content">
        <p className="hero-tech-label">
          BLACKOUT / DROP 01 / NIGHT USE ONLY
        </p>
        ...
        <p className="hero-statement">
          Slutt å sove <span className="text-strike">i interiør</span>.
        </p>
        <p className="body-text hero-body">
          Sengen din er ikke et stilleben. Den er der huden møter stoff, håret
          gnisser mot puta, kroppen blir varm, svetter, hviler og prøver å hente
          seg inn. BLACKOUT lager sengetøy for kroppen. Ikke for boligstylisten.
        </p>
